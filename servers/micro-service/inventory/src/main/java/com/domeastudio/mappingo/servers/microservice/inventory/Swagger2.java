package com.domeastudio.mappingo.servers.microservice.inventory;
...
public class Swagger2 {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.domeastudio.mappingo.servers.microservice.inventory.rest"))
